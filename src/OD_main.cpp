...
int main(int argc, char **argv)
{
	...
	while (1){
		...
		free(sIVA_OBJECT_DETECT_INFOp.originImage.pImage);
		free(sIVA_OBJECT_DETECT_INFOp.resultImage.pImage);
		delete sIVA_OBJECT_DETECT_INFOp.pLabelInfo;
		DestoryObjectDetectDLLHandle(oDDATA);
